...
## Bucket CORS Helper (Issue #12)

- Buckets page includes a `Copy CORS Policy` button.
- Use it after adding a new bucket and paste policy in AWS S3 bucket Permissions -> CORS.
- This prevents browser chunk upload errors for newly added buckets.
